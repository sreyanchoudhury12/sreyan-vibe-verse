    ...
    <div className="relative flex flex-col md:flex-row items-center justify-center min-h-[80vh] px-8 py-8 md:py-20 bg-gradient-to-br from-black via-zinc-900 to-gray-900">
      <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-5 md:space-y-7 z-10">
        <img
          src={profilePic}
          alt="Sreyan Avatar"
          className="w-28 h-28 md:w-36 md:h-36 rounded-full border-4 border-pink-500 shadow-xl mb-3 animate-scale-in"
        />
      ...
      {/* Edge floating shape */}
      <div className="absolute top-6 right-4 md:right-24 w-24 h-24 bg-gradient-to-br from-fuchsia-400/80 to-cyan-300/40 blur-2xl rounded-full opacity-60 pointer-events-none animate-fade-in" />
    </div>
  );
};
